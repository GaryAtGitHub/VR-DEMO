...
namespace VRTK
{
    ...
    public class VRTK_SnapDropZone : MonoBehaviour
    {
        ...
        public enum SnapTypes
        {
            ...
            UseParenting,
            /// <summary>
            /// will remove interactable object rigidbody.
            /// </summary>
            CustomSnap,
            /// <summary>
            /// will snap obi cable snapped to modem, and enable proper physics
            /// </summary>
            CustomeModemCableSnap,
        }
        ...
        protected virtual void SetDropSnapType(VRTK_InteractableObject ioCheck)
        {
            ...
            switch (snapType)
            {
                ...
                case SnapTypes.UseJoint:
                    ...
                    break;
                case SnapTypes.CustomSnap:
                    ioCheck.SaveCurrentState();
                    rigidbody = ioCheck.GetComponent<Rigidbody>();
                    if (rigidbody != null)
                    {
                        ioCheck.SaveCurrentRigidbodyDetailedState();
                        Destroy(rigidbody);
                    }
                    ioCheck.transform.SetParent(transform);
                    break;
                case SnapTypes.CustomeModemCableSnap:
                    ioCheck.SaveCurrentState();
                    Cable cable = ioCheck.GetComponentInParent<Cable>();
                    rigidbody = ioCheck.GetComponent<Rigidbody>();
                    if (rigidbody != null)
                    {
                        ioCheck.SaveCurrentRigidbodyDetailedState();
                    }
                    cable.SnapCabel(ioCheck.gameObject);
                    if (rigidbody != null)
                    {
                        Destroy(rigidbody);
                    }
