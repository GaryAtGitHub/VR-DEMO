...
namespace VRTK
{
    ...
    public class VRTK_InteractableObject : MonoBehaviour
    {
        ...
        protected float previousMass;
        protected float previousAngularDrag;
        protected float previousDrag;
        protected bool previousIsUseGravity;
        ...
        public virtual void SaveCurrentRigidbodyDetailedState()
        {
            if (interactableRigidbody != null)
            {
                previousMass = interactableRigidbody.mass;
                previousAngularDrag = interactableRigidbody.angularDrag;
                previousDrag = interactableRigidbody.drag;
                previousIsUseGravity = interactableRigidbody.useGravity;
            }
        }
...
#pragma warning restore 0618
        ...
        protected virtual void LoadPreviousRigidbodyDetailedState()
        {
            interactableRigidbody.WakeUp();
            interactableRigidbody.mass = previousMass;
            interactableRigidbody.angularDrag = previousAngularDrag;
            interactableRigidbody.drag = previousDrag;
            interactableRigidbody.useGravity = previousIsUseGravity;
        }
        ...
        protected virtual void ResetDropSnapType()
        {
            switch (storedSnapDropZone.snapType)
            {
                ...
                case VRTK_SnapDropZone.SnapTypes.UseJoint:
                    ...
                    break;
                case VRTK_SnapDropZone.SnapTypes.CustomSnap:
                    interactableRigidbody = GetComponent<Rigidbody>();
                    if (interactableRigidbody == null)
                    {
                    ...
                    LoadPreviousState();
                    LoadPreviousRigidbodyDetailedState();
                    PauseCollisions(0.1f);
                    break;
                case VRTK_SnapDropZone.SnapTypes.CustomeModemCableSnap:
                    interactableRigidbody = GetComponent<Rigidbody>();
                    if (interactableRigidbody == null)
                    {
                        interactableRigidbody = gameObject.AddComponent<Rigidbody>();
                    ...
                    LoadPreviousState();
                    LoadPreviousRigidbodyDetailedState();
                    GetComponentInParent<Cable>()?.SnapCabel(gameObject, false);
                    //PauseCollisions(0.1f);
                    break;
            }
